...
<head>
	...
	<meta name="Description" content="AM Systems - Sistema para Clínicas Odontológicas">
	<meta name="Author" content="Abel Macedo">
	<meta name="Keywords" content="amsystems - sistema odontológico, abel macedo, odontologia" />
			...
			<div class="main-footer">
				<div class="container-fluid pt-0 ht-100p">
					Copyright © <?php echo date('Y'); ?> Desevolverdor: <a href="https://www.monielsistemas.com.br" target="_blank"
						class="text-primary"> AM Systems - Sistema Odontológico / Abel Macedo</a>. Todos
